...
Bella Bay (“we,” “our,” or “us”) is committed to protecting the privacy and security of all individuals whose information is processed through our platform, including donors, administrators, employees, residents, and other authorized users.

This Privacy Notice explains how we collect, use, store, and protect personal information when you access our website, donor dashboard, administrative portal, and case inventory system.
...
**[privacy@bellaporto.org](mailto:privacy@bellaporto.org)**

---

## 2. Information We Collect

### Donor and Public User Information
...
Guest donors may provide donation-related information without creating an account.

---

## 3. Resident and Case Management Information
...
We may also receive data from authorized nonprofit staff, case workers, or partner organizations.
...
Third-party providers only receive the minimum information necessary to perform their services.
...
Our website may use limited cookies and similar technologies for:
...
Under GDPR and applicable U.S. privacy laws, users may request:
...
We may update this Privacy Notice periodically. Updated versions will be posted on this page with a revised effective date.
