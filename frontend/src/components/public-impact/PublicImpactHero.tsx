    ...
    <section className="relative min-h-screen overflow-hidden">
      <div className="absolute inset-0">
        <img
          ...
          className="h-full min-h-screen w-full object-cover object-[72%_28%] md:object-[72%_24%]"
        />
      ...
      <div className="container relative z-10 mx-auto px-4 py-24 md:py-36">
        <div className="grid min-h-screen items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.95fr)]">
          <div className="max-w-2xl">
            <h1 className="font-heading text-4xl font-bold leading-tight text-white drop-shadow-lg sm:text-5xl md:text-6xl lg:text-7xl">
              Your Impact
            </h1>
